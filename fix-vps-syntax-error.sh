...
# Check syntax of analytics.js
echo "Checking analytics.js syntax..."
node -c src/routes/analytics.js

if [ $? -ne 0 ]; then
    echo "❌ Syntax error found in analytics.js"
...
EOF
    ...
    echo "✅ analytics.js file recreated"
else
    echo "✅ analytics.js syntax is OK"
fi
